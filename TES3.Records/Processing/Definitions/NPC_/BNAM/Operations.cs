...
namespace TES3.Records.Processing.Definitions.NPC_.BNAM 
{
	
	[HandlesSubRecord("NPC_", "BNAM")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "BNAM", Names.InitialSubRecordOrder);
		}
