...
namespace TES3.Records.Processing.Definitions.NPC_.CNAM 
{
	
	[HandlesSubRecord("NPC_", "CNAM")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "CNAM", Names.InitialSubRecordOrder);
		}
