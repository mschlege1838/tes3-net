...
namespace TES3.Records.Processing.Definitions.NPC_.KNAM 
{
	
	[HandlesSubRecord("NPC_", "KNAM")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "KNAM", Names.InitialSubRecordOrder);
		}
