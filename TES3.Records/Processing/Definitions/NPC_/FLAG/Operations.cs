...
namespace TES3.Records.Processing.Definitions.NPC_.FLAG 
{
	
	[HandlesSubRecord("NPC_", "FLAG")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "FLAG", Names.InitialSubRecordOrder);
		}
