...
namespace TES3.Records.Processing.Definitions.NPC_.NPCO 
{
	
	[HandlesSubRecord("NPC_", "NPCO")]
    static class Operations
	{
		...
		internal static object Write(SubRecordWriteContext context)
		{
            ...
            WriteBytes(context.stream, GetBytes(item.ItemName, Constants.NPCO_ITEM_NAME_LENGTH, "NPC_.NPCO.Name"));
			return null;
		}
		...
		{
            return GetAddIndexOrdered(context.record, "NPCO", Names.InitialSubRecordOrder);
		}
