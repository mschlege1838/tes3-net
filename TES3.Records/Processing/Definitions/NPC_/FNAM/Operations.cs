...
namespace TES3.Records.Processing.Definitions.NPC_.FNAM 
{
	
	[HandlesSubRecord("NPC_", "FNAM")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "FNAM", Names.InitialSubRecordOrder);
		}
