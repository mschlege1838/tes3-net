...
namespace TES3.Records.Processing.Definitions.NPC_.SCRI 
{
	
	[HandlesSubRecord("NPC_", "SCRI")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "SCRI", Names.InitialSubRecordOrder);
		}
