...
namespace TES3.Records.Processing.Definitions.FACT.NAME 
{
	
	[HandlesSubRecord("FACT", "NAME")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "NAME", Names.InitialSubRecordOrder);
		}
