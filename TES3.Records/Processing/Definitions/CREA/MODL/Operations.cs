...
namespace TES3.Records.Processing.Definitions.CREA.MODL 
{
	
	[HandlesSubRecord("CREA", "MODL")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "MODL", Names.InitalSubRecordOrder);
		}
