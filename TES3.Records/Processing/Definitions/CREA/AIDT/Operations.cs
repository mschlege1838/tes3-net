...
namespace TES3.Records.Processing.Definitions.CREA.AIDT 
{
	
	[HandlesSubRecord("CREA", "AIDT")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "AIDT", Names.InitalSubRecordOrder);
		}
