...
namespace TES3.Records.Processing.Definitions.CREA.NAME 
{
	
	[HandlesSubRecord("CREA", "NAME")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "NAME", Names.InitalSubRecordOrder);
		}
