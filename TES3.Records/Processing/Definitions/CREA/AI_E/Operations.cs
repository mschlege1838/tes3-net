...
namespace TES3.Records.Processing.Definitions.CREA.AI_E 
{
	
	[HandlesSubRecord("CREA", "AI_E")]
    static class Operations
	{
		...
		internal static object Write(SubRecordWriteContext context)
		{
            ...
            WriteBytes(context.stream, GetBytes(aiData.Id, Constants.AI_X_ID_LENGTH, $"CREA.context.subRecord.Name.Id"));
