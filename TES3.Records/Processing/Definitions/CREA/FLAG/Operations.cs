...
namespace TES3.Records.Processing.Definitions.CREA.FLAG 
{
	
	[HandlesSubRecord("CREA", "FLAG")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "FLAG", Names.InitalSubRecordOrder);
		}
