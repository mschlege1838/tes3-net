...
namespace TES3.Records.Processing.Definitions.CREA.CNAM 
{
	
	[HandlesSubRecord("CREA", "CNAM")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "CNAM", Names.InitalSubRecordOrder);
		}
