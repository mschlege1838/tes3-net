...
namespace TES3.Records.Processing.Definitions.CREA.FNAM 
{
	
	[HandlesSubRecord("CREA", "FNAM")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "FNAM", Names.InitalSubRecordOrder);
		}
