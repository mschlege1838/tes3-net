...
namespace TES3.Records.Processing.Definitions.CREA.DELE 
{
	
	[HandlesSubRecord("CREA", "DELE")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "DELE", Names.InitalSubRecordOrder);
		}
