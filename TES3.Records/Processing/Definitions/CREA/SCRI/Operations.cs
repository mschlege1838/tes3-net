...
namespace TES3.Records.Processing.Definitions.CREA.SCRI 
{
	
	[HandlesSubRecord("CREA", "SCRI")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "SCRI", Names.InitalSubRecordOrder);
		}
