...
namespace TES3.Records.Processing.Definitions.ARMO.ITEX 
{
	
	[HandlesSubRecord("ARMO", "ITEX")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "ITEX", Names.InitialSubRecordOrder);
		}
