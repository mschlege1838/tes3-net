...
namespace TES3.Records.Processing.Definitions.CLOT.ENAM 
{
	
	[HandlesSubRecord("CLOT", "ENAM")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "ENAM", Names.InitialSubRecordOrder);
		}
