...
namespace TES3.Records.Processing.Definitions.CLOT.MODL 
{
	
	[HandlesSubRecord("CLOT", "MODL")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "MODL", Names.InitialSubRecordOrder);
		}
