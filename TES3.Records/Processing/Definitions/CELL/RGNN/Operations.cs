...
namespace TES3.Records.Processing.Definitions.CELL.RGNN 
{
	
	[HandlesSubRecord("CELL", "RGNN")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "RGNN", Names.InitialSubRecordOrder);
		}
