...
namespace TES3.Records.Processing.Definitions.CELL.NAM0 
{
	
	[HandlesSubRecord("CELL", "NAM0")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "NAM0", Names.InitialSubRecordOrder);
		}
