...
namespace TES3.Records.Processing.Definitions.CELL.WHGT 
{
	
	[HandlesSubRecord("CELL", "WHGT")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "WHGT", Names.InitialSubRecordOrder);
		}
