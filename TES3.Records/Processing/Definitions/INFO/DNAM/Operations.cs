...
namespace TES3.Records.Processing.Definitions.INFO.DNAM 
{
	
	[HandlesSubRecord("INFO", "DNAM")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "DNAM", Names.InitialSubRecordOrder);
		}
