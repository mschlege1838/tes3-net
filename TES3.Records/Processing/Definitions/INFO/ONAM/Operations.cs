...
namespace TES3.Records.Processing.Definitions.INFO.ONAM 
{
	
	[HandlesSubRecord("INFO", "ONAM")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "ONAM", Names.InitialSubRecordOrder);
		}
