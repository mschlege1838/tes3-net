...
namespace TES3.Records.Processing.Definitions.INFO.PNAM 
{
	
	[HandlesSubRecord("INFO", "PNAM")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "PNAM", Names.InitialSubRecordOrder);
		}
