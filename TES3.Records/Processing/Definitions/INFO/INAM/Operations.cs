...
namespace TES3.Records.Processing.Definitions.INFO.INAM 
{
	
	[HandlesSubRecord("INFO", "INAM")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "INAM", Names.InitialSubRecordOrder);
		}
