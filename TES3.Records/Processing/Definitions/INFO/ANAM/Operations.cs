...
namespace TES3.Records.Processing.Definitions.INFO.ANAM 
{
	
	[HandlesSubRecord("INFO", "ANAM")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "ANAM", Names.InitialSubRecordOrder);
		}
