...
namespace TES3.Records.Processing.Definitions.INFO.NNAM 
{
	
	[HandlesSubRecord("INFO", "NNAM")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "NNAM", Names.InitialSubRecordOrder);
		}
