...
namespace TES3.Records.Processing.Definitions.INFO.DELE 
{
	
	[HandlesSubRecord("INFO", "DELE")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "DELE", Names.InitialSubRecordOrder);
		}
