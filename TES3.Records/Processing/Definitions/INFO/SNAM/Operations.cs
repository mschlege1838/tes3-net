...
namespace TES3.Records.Processing.Definitions.INFO.SNAM 
{
	
	[HandlesSubRecord("INFO", "SNAM")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "SNAM", Names.InitialSubRecordOrder);
		}
