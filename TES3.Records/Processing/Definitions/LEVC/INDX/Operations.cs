...
namespace TES3.Records.Processing.Definitions.LEVC.INDX 
{
	
	[HandlesSubRecord("LEVC", "INDX")]
    static class Operations
	{
		...
		{
            return GetAddIndexOrdered(context.record, "INDX", Names.InitialSubRecordOrder);
		}
